...
function CheckboxList({ checkedItems, onCheckboxChange, handleShow, setHandleShow }) {
          ...
          <div className={`slide-in fade card ${!handleShow ? '' : 'active show'} card-body my-2 bg-gray-dark-light`}>
            <div className="row text-white">
              ...
              <div className="col-lg-11 col-11 row">
                ...
                <div className="col-lg-4 col-4"><i className="fa fa-location-arrow text-primary"></i><span className="mx-2" style={{ fontSize: "10pt" }}>{item.jarak} Km</span></div>
                <div className="col-lg-6 col-6"><i className="fa fa-clock text-primary"></i> <span className="mx-2" style={{ fontSize: "10pt" }}>{item.waktu} Menit</span></div>
              </div>
            </div>
          </div>
        </li>
...
function ListDataAccordion({ data, onCheckboxChange }) {
    ...
    <div className="accordion col-12 ">
      ...
      {isOpen && (
        <div className="accordion-body py-1 px-2 border border-top-0 border-dark rounded-bottom" style={{ cursor: "default" }}>
          <CheckboxList checkedItems={data} onCheckboxChange={onCheckboxChange} handleShow={handleShow} setHandleShow={setHandleShow} />
        </div>
      )}
    </div>
  );
